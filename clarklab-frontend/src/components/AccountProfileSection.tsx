...
export function AccountProfileSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      <details className="theme-glass rounded-2xl border p-4">
        <summary className="theme-heading cursor-pointer text-sm font-semibold">Change password</summary>
      ...
      <PageButton type="button" className="w-full" onClick={handleSaveAccount} disabled={accountLoading || accountSaving}>
