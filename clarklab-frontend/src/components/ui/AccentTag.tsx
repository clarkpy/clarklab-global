  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        isButton && 'cursor-pointer hover:border-violet-400/45 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/30 disabled:cursor-not-allowed disabled:opacity-50',
        className,
      )}
    >
