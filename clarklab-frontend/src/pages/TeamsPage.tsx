...
import { Users, Plus, ChevronRight, Search, FolderKanban } from 'lucide-react'
      ...
      <Reveal delay={0}>
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            <h1 className="theme-heading text-5xl font-black tracking-tight sm:text-6xl">Teams</h1>
            <p className="theme-subheading mt-4 max-w-xl text-sm leading-7">
              Group projects and control who can view, deploy, and manage services.
            </p>
          </div>
          <button
            type="button"
        ...
        <>
          ...
          <Reveal delay={80}>
            <div className="relative mb-6 max-w-md">
              <Search
                className="theme-muted pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2"
                aria-hidden="true"
              />
              <Input
                value={search}
